...
\def\shortanswerquestion#1#2{%
    \answerQuestion{#1}{#2}{1.2cm}%
    \advance\questionCnt by 1
}

\def\mediumanswerquestion#1#2{%
    \answerQuestion{#1}{#2}{4cm}%
    \advance\questionCnt by 1
}

\def\longanswerquestion#1#2{%
    \answerQuestion{#1}{#2}{8cm}%
    \advance\questionCnt by 1
}
...
\shortanswerquestion{How many prime numbers are there?}{2}

\mediumanswerquestion{How many prime numbers are there? Add some insight.}{3}

\longanswerquestion{How many prime numbers are there? Prove it.}{4}
